    ...
    <div class="relative z-10 p-[15%] font-poppins">
        <div class="flex flex-col font-poppins">
            ...
            <div class="text-[24px] flex flex-row gap-4">
                ...
                <a href="/register" class="hover:text-navy hover:bg-linen border-[1px] text-light border-black active:bg-black active:text-linen focus:ring focus:ring-black rounded-[10px] p-3 px-5">
                    Sign Up
                </a>
            </div>
        </div>
