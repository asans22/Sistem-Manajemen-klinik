...
<div class="relative bg-black">
    ...
    <div class="relative z-10 p-[15%] font-poppins">
        <div class="flex flex-col font-poppins">
            ...
            <div class="text-[24px] flex flex-row gap-4">
                <a href="/login" class="text-linen bg-navy border-[1px] border-navy hover:text-navy hover:bg-blue-sky active:bg-black active:text-linen focus:ring focus:ring-linen rounded-[10px] p-3 px-7">
                    Log In
                </a>

                <a href="/registrasi" class="hover:text-navy hover:bg-linen border-[1px] text-light border-black active:bg-black active:text-linen focus:ring focus:ring-black rounded-[10px] p-3 px-5">
                    Sign Up
                </a>
            </div>
        </div>
