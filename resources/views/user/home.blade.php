    ...
    <div class="flex justify-center gap-10 text-center font-poppins">
        <a href="/dokterUser" class="w-[40%] hover:shadow-navy p-16 my-16 shadow-md rounded-lg border-solid border-[1px] border-blue flex flex-col justify-center items-center transform hover:scale-105 transition duration-300">
        ...
        <a href="/obatUser" class="w-[40%] hover:shadow-navy p-16 my-16 shadow-md  rounded-lg border-solid border-[1px] border-blue flex flex-col justify-center items-center transform hover:scale-105 transition duration-300">
            <div class="mx-24 pb-48">
                <div class="mx-auto rounded-full bg-linen h-24 w-24 flex items-center justify-center mb-6">
