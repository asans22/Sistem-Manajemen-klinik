...
@section('container')
    ...
    <div class="box-border border-2 border-button hover:bg-neon ml-10  inline-block mb-5 py-1 px-3  rounded-md text-base font-semibold bg-blue-sky  text-navy hover:text-blue">
        <p>Tambah</p>
    </div>
            ...
            <tbody>
                <tr class="h-8">
                    ...
                    <td class="border-2 border-black">
                        <button class="box-border border-2 flex flex-row w-16  px-2 rounded text-white border-button bg-navy mx-auto py-0.5 hover:scale-105 active:scale-100 hover:duration-75">
