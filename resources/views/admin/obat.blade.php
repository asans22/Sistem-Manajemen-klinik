                ...
                <tr class="h-8">
                    ...
                    <td class="border-2 border-black">
                        <div class="flex flex-row justify-center">
                            <button data-id="{{ $obat->id }}" class="openEditModal box-border border-2 flex flex-row w-16 px-2 rounded text-white border-button bg-navy mr-5 py-0.2 hover:scale-105 active:scale-100 hover:duration-75">
