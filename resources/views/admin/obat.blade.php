...
@section('container')
            ...
            <tbody>
                ...
                <tr class="h-8">
                    ...
                    <td class="border-2 border-black">
                        <div id="openEditObat" class="flex flex-row justify-center">
                            <button class="box-border border-2 flex flex-row w-16 px-2 rounded text-white border-button bg-navy mr-5 py-0.2 hover:scale-105 active:scale-100 hover:duration-75">
                                ...
                                <p data-toggle="modalEdit" data-target="#modalEdit">edit</p>
                            </button>
                            <button class="box-border border-2 flex flex-row w-16 px-2 rounded text-white border-red-700 bg-red-600  py-0.2 hover:scale-105 active:scale-100 hover:duration-75">
                                <svg width="15" height="15" viewBox="0 0 144 144" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M107.753 0L89.7943 17.9589L125.712 53.8766L143.671 35.9177L107.753 0ZM71.8355 35.9177L0 107.753V143.671H35.9177L107.753 71.8355L71.8355 35.9177Z" fill="white"/>
                                </svg>
                                <p>Hapus</p>
    ...
    <script>
        ...
        document.getElementById('openEditObat').addEventListener('click',function () {
