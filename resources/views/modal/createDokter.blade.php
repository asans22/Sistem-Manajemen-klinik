...
<div id="modalCreateDokter" class="fixed z-10 inset-0 overflow-y-auto hidden">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <form method="POST" action="{{ route('dokter.store') }}">
                                ...
                                <div class="mb-4">
                                    <label for="id_dokter" class="block text-gray-700 text-sm font-bold mb-2">ID Dokter:</label>
                                    <input type="text" name="id_dokter" id="id_dokter" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                                </div>
                                <div class="mb-4">
